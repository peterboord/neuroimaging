...
%     end
    % From http://www.mathworks.com/matlabcentral/fileexchange/10803-barweb--bargraph-with-error-bars-
    % 02 Jun 2015 Flo To get the code back working with R2015a (8.5.0.197613), the plot errors loop has to be changed to:
    for i = 1:numbars
