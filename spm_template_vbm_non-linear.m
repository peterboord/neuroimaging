...
%-----------------------------------------------------------------------
%%
matlabbatch{1}.spm.tools.vbm8.estwrite.data = '<UNDEFINED>';
%%
matlabbatch{1}.spm.tools.vbm8.estwrite.opts.tpm = {'/NAS_II/Home/pboord/Documents/MATLAB/spm8/toolbox/Seg/TPM.nii'};
...
matlabbatch{1}.spm.tools.vbm8.estwrite.extopts.dartelwarp.normhigh.darteltpm = {'/NAS_II/Home/pboord/Documents/MATLAB/spm8/toolbox/vbm8/Template_1_IXI550_MNI152.nii'};
...
matlabbatch{1}.spm.tools.vbm8.estwrite.output.jacobian.warped = 1;
